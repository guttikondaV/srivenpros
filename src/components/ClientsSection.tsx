        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
          {clients.map((c, i) => (
            <motion.div
              ...
              className="flex flex-col items-center justify-center rounded-xl bg-card border border-border/60 py-6 px-4 shadow-card hover:shadow-elevated hover:border-accent/30 transition-all gap-3"
            >
              <img
                src={c.logo}
                alt={`${c.name} logo`}
